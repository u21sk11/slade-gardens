...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="py-8 min-h-screen bg-gray-50 flex items-center justify-center bg-[url(./src/assets/user-login-bg.webp)] bg-cover bg-center bg-blend-luminosity">
      <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-5 mb-5">
      ...
      <Accordian items={policyItems} />
        ...
        <details className="group mb-4">
          ...
          <p className="text-gray-600 mt-2 pl-5">
            We only keep your data for as long as necessary for safety, legal,
            and operational reasons. Once it's no longer needed, we securely
        ...
        <details className="group mb-4">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-1 mt-2 pl-5">
            ...
            <li>
              With authorized staff or volunteers who need the information to
              keep everyone safe.
            </li>
          </ul>
        </details>
        ...
        <details className="group mb-4">
          ...
          <p className="text-gray-600 mt-2 pl-5">
            ...
            will be posted here, so feel free to check back.
          </p>
        </details>
