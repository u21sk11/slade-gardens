          ...
          <div className="md:text-left flex flex-col">
            ...
            <div className="space-y-2 mt-1">
              <p className="text-gray-600 flex items-center gap-2">
                ...
                <a href="tel:02077373829" className="text-green-600 hover:underline">0207 737 3829</a>
              </p>
              <p className="text-gray-600 flex items-center gap-2">
                <svg className="w-5 h-5 text-gray" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:sladeadventure@btinternet.com" className="text-green-600 hover:underline">sladeadventure@btinternet.com</a>
              </p>
            </div>
          </div>
        </div>  
    ...
    <section className="mb-8">
      ...
      <section>
        ...
        <form className="space-y-6">
          <div className="space-y-2">
            <label className="block text-sm font-bold text-green-600">Your Name</label>
            <input
              type="text"
          ...
          <div className="space-y-2">
            <label className="block text-sm font-bold text-green-600">Email Address</label>
            <input
              type="email"
              className="w-full p-3 border border-green-300 rounded-lg focus:outline-none focus:border-green-500"
          ...
          <div className="space-y-2">
            <label className="block text-sm font-bold text-green-600">Message</label>
            <textarea
              rows="4"
              className="w-full p-3 border border-green-300 rounded-lg focus:outline-none focus:border-green-500"
